...
namespace Puchase_and_payables.Contracts.Response.Purchase
{
    ...
    public class LPOObj
    {
        public LPOObj()
        {
            Taxes = new List<TaxObj>();
            BidAndTender = new List<BidAndTenderObj>();
            RequisitionNotes = new List<RequisitionNoteObj>();
            PaymentTerms = new List<PaymentTermsObj>();
        }
