...
namespace Puchase_and_payables.Contracts.V1
{
    public class ApiRoutes
    {
        ...
        public static class Identity
        {
            ...
            public const string RECOVER_PASSWORD_BY_EMAIL = Base + "/ppidentity/recoverpassword/byemail";
            public const string NEW_PASS = Base + "/ppidentity/newpassword";
        }
        ...
        public static class FinanceServerRequest
        {
            ...
            public const string GET_OTHER_BANKS = "/bankgl/get/all/other_banks";
            public const string GET_SINGLE_OTHER_BANK = "/bankgl/get/single/other_banks";
        ...
        public static class SupplierEndpoints
        {
            ...
            public const string GET_SINGLE_TERM = Base + "/supplier/get/single/serviceTerm/serviceTermId";
        ...
        public static class OnWebSupplierEndpoints
        {
            ...
            public const string GET_SUGGESTED_SUPPLIER_BIDs = Base + "/onwebsupplier/get/suggetsted/supplierbids";
            ...
            public const string GET_DASHBOARD_COUNT = Base + "/onwebsupplier/dashbordcount";
        }
        public static class Purchases
        {
            ...
            public const string MODIFY_PRN_DETAILS = Base + "/purchase/modify/prn_details";
            public const string MODIFY_BIDS = Base + "/purchase/modify/bids";
