...
namespace Puchase_and_payables.Handlers.Purchase.LPOs
{
    public class GetSingleLPOQuery : IRequest<LPORespObj>
    {
        ...
        public class GetSingleLPOQueryHandler : IRequestHandler<GetSingleLPOQuery, LPORespObj>
        {
            ...
            public GetSingleLPOQueryHandler(DataContext dataContext, IPurchaseService purchaseService, ISupplierRepository supplierRepository)
            {
                ...
                try
                {
                    ...
                    if (d != null)
                    {
                        var LPO = new LPOObj
                        {
                            ...
                            PaymentTerms = _dataContext.cor_paymentterms.Where(r => r.BidAndTenderId == d.BidAndTenderId).Select(c => new PaymentTermsObj
                            {
