            ...
            public async Task<BidAndTenderRegRespObj> Handle(UploadProposalCommand request, CancellationToken cancellationToken)
            {
                ...
                try
                {
                    ...
                    if (file.Count() > 0)
                    {
                        ...
                        bidAndTenderObj.ProposalTenderUploadFullPath = filePath;
                        bidAndTenderObj.ProposalTenderUploadName = filePath;
                        bidAndTenderObj.ProposalTenderUploadPath = filePath;
